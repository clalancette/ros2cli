...
def _create_template_file(template_subdir, template_file_name, output_directory, output_file_name, template_config):
    full_package = 'ros2pkg.resource.' + template_subdir
    with importlib.resources.path(full_package, template_file_name) as path:
